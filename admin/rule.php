...
<head>
    ...
    <title>Data Rule - LapMatch</title>
        ...
        <div class="table-container">
            <table class="custom-table">
                ...
                <tbody>
                    <?php
                    $no = 1;
                    $data = mysqli_query($koneksi, "SELECT rule.*, laptop.nama_laptop FROM rule JOIN laptop ON rule.id_laptop=laptop.id_laptop");
                    ...
                    <tr>
                        ...
                        <td>
                            <span class="laptop-badge">
                                ...
                                <?= htmlspecialchars($d['nama_laptop']) ?>
                            </span>
                        </td>
                        <td>
                            <a href="edit_rule.php?id=<?= $d['id_rule'] ?>" class="btn-edit">
                                <i class="bi bi-pencil"></i> Edit
                            </a>
                            <a href="hapus_rule.php?id=<?= $d['id_rule'] ?>" class="btn-hapus" onclick="return confirm('Yakin mau hapus rule ini?')">
                    ...
                    <tr>
                        <td colspan="5">
                            <div class="empty-state">
                                ...
                                <h4>Belum ada rule yang dibuat</h4>
                                <p>Silakan tambah rule baru untuk sistem rekomendasi</p>
                            </div>
                        </td>
                    </tr>
                    <?php } ?>
